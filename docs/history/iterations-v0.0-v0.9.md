# pgBrain iteration log, v0.0.1 → v0.9.7 (archived)

Frozen record of iterations 1–46 (2026-05-20 → 2026-06-09). Everything marked
"unreleased" here shipped by v0.9.7. The live plan is `PLAN.md` at the repo root.
